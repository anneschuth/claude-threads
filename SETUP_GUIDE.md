...
- **Install** Claude Code CLI: `npm install -g @anthropic-ai/claude-code@2.1.223`
...
- **Install** the latest verified version: `npm install -g @anthropic-ai/claude-code@2.1.223`

...
export function createMockSessionContext(makePlatform: () => import('../platform/index.js').PlatformClient, sessions: Map<string, Session> = new Map()): SessionContext {
  ...
  return {
    ...
    beginInteractivePost: mock(() => () => {}),
      ...
      getPlatformOverhead: mock(() => ({ sessionHeader: 'full' as const, stickyMessage: 'full' as const, lifecycle: 'full' as const, turnMarker: { mode: 'off' as const }, tools: { activity: 'full' as const, details: 'none' as const } })),

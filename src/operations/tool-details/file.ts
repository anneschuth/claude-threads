 ...
 * everything outside [A-Za-z0-9-] becomes `_XXXX`, four hex digits per UTF-16
 * code unit, so the mapping is injective and `.`/`..` cannot occur. ':' in
 * session ids is the usual case.
 *
